<?php
    ...
    if (!$result) {
        ...
        //テーブル作成
        $result1 = mysqli_query($link, "CREATE TABLE $user_table (id INT NOT NULL AUTO_INCREMENT, user_mail VARCHAR(50)BINARY NOT NULL, user_password VARCHAR(50)BINARY NOT NULL,PRIMARY KEY(id)) CHARACTER SET utf8");
